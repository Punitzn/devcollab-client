  ...
  return (
    <div className='create-page'>
      ...
      <form onSubmit={handleSubmit} className='create-form'>
        {/* Code Editor (Monaco in macOS wrapper) */}
        <div className='form-group'>
          <label className='form-label'>Code *</label>
          <div className="code-block-wrapper" style={{ marginBottom: '0' }}>
        ...
        <div className='create-fields-grid'>
          ...
          <div className='form-group grid-col-span-2'>
            ...
            <span className='form-hint'>Press Enter or Comma (,) to add. Click "x" or press backspace to remove.</span>
          </div>
        </div>

        <div style={{ display: 'flex', gap: '0.75rem', paddingTop: '1rem', borderTop: '1px solid var(--border)', marginTop: '0.5rem' }}>
          <button
            type='submit'
